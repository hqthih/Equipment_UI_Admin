enum EEquipmentActions {
  ...
  HISTORY_TRANSFER_EQUIPMENT = "HISTORY_TRANSFER_EQUIPMENT",
  HISTORY_TRANSFER_EQUIPMENT_REQUEST = "HISTORY_TRANSFER_EQUIPMENT_REQUEST",
  HISTORY_TRANSFER_EQUIPMENT_SUCCESS = "HISTORY_TRANSFER_EQUIPMENT_SUCCESS",
  HISTORY_TRANSFER_EQUIPMENT_FAILURE = "HISTORY_TRANSFER_EQUIPMENT_FAILURE",
}
